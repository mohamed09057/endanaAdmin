...
class EditProductOptions extends StatefulWidget {
  final List list;
  final int index;

  EditProductOptions({this.list, this.index});
  @override
  _EditProductOptionsState createState() => _EditProductOptionsState();
}

class _EditProductOptionsState extends State<EditProductOptions> {
  ...
  void initState() {
    ...
    supplierPhoneNumber = new TextEditingController(
        ...
        name1 = new TextEditingController(
        text: widget.list[widget.index]["options"][0]["title"]);
        name2 = new TextEditingController(
        text: widget.list[widget.index]["options"][1]["title"]);
        price1 = new TextEditingController(
        text: widget.list[widget.index]["options"][0]["price"]);
        price2 = new TextEditingController(
        text: widget.list[widget.index]["options"][1]["price"]);
                                ...
                                child: _image4 == null
                                    ? Image(
                                        image: widget
                                                ...
                                                0
                                            ? NetworkImage(
                                                "https://endana.neversd.com/${widget.list[widget.index]["options"][0]["images"][0]["image"]}",
                                              )
                                            : AssetImage(
                                                'assets/imgages/1.png'),
                                        fit: BoxFit.cover)
                                ...
                                child: _image5 == null
                                    ? Image(
                                        image: widget
                                                ...
                                                0
                                            ? NetworkImage(
                                                "https://endana.neversd.com/${widget.list[widget.index]["options"][0]["images"][1]["image"]}",
                                              )
                                            : AssetImage(
                                                'assets/imgages/1.png'),
                                        fit: BoxFit.cover)
                                ...
                                child: _image6 == null
                                    ? Image(
                                        image: widget
                                                ...
                                                0
                                            ? NetworkImage(
                                                "https://endana.neversd.com/${widget.list[widget.index]["options"][0]["images"][2]["image"]}",
                                              )
                                            : AssetImage(
                                                'assets/imgages/1.png'),
                                        fit: BoxFit.cover)
                                ...
                                child: _image7 == null
                                    ? Image(
                                        image: widget
                                                ...
                                                0
                                            ? NetworkImage(
                                                "https://endana.neversd.com/${widget.list[widget.index]["options"][1]["images"][0]["image"]}",
                                              )
                                            : AssetImage(
                                                'assets/imgages/1.png'),
                                        fit: BoxFit.cover)
                                ...
                                child: _image8 == null
                                    ? Image(
                                        image: widget
                                                ...
                                                0
                                            ? NetworkImage(
                                                "https://endana.neversd.com/${widget.list[widget.index]["options"][1]["images"][1]["image"]}",
                                              )
                                            : AssetImage(
                                                'assets/imgages/1.png'),
                                        fit: BoxFit.cover)
                                ...
                                child: _image9 == null
                                    ? Image(
                                        image: widget
                                                ...
                                                0
                                            ? NetworkImage(
                                                "https://endana.neversd.com/${widget.list[widget.index]["options"][1]["images"][2]["image"]}",
                                              )
                                            : AssetImage(
                                                'assets/imgages/1.png'),
                                        fit: BoxFit.cover)
